...
const data = [
  {
    ...
    details: "• Starting January 8 for second co-op term. <br>• Will work alongside the Division's Regional Business Planing Manager to design and develop database. " +
...
const Experience = () => {
  return (
    <div id="experience" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16 border">
