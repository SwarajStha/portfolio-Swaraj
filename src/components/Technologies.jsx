...
const Technologies = () => {
  ...
  return (
    <div id='technologies'>
      <div className="max-w-[1000px] m-auto h-full w-full flex flex-col p-4 justify-center item-center">
        <h1 className="py-4 text-4xl font-bold text-center text-black pt-12 justify-center item-center">
          TECHNOLOGIES
        </h1>
        <div className="flex sm:text-2xl text-l text-gray-800 justify-left">
        ...
        <div className="item-center">
          <div className="w-full grid grid-cols-2 sm:grid-cols-6 gap-3 text-center py-8">
            ...
            <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
              <img className="w-15 mx-auto pt-2" src={Java} alt="Python icon" />
            ...
            <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
              <img className="w-15 mx-auto pt-2" src={HTML} alt="Python icon" />
              <p className="my-4">HTML</p>
            </div>
            <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
              <img className="w-15 mx-auto pt-2" src={CSS} alt="Python icon" />
