...
const ExperienceCard = ({ experience, onSelect }) => {
  return (
    <div
      onClick={onSelect}
      className="relative w-full p-6 bg-slate-700/50 border border-slate-600 rounded-lg shadow-lg cursor-pointer transition-transform duration-300 hover:scale-105"
    >
